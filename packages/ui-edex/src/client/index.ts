...
import systemMetricsRemote from '@danielng23/dsh-lockon-host-system-metrics/remote'
import {
...
import type { CommandResult } from '@danielng23/dsh-lockon-host-system-metrics/types'
